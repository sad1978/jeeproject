...
insert into persona (id, nombre,fecha_nacimiento,salario) values (1, 'nom1', '1980-07-30',1000);
insert into persona (id, nombre,fecha_nacimiento,salario) values (2, 'nom2', '1990-11-02',2000);
insert into persona (id, nombre,fecha_nacimiento,salario) values (3, 'nom3', '1964-02-28',3000);
insert into persona (id, nombre,fecha_nacimiento,salario) values (4, 'nom3', '1965-07-28',2000);